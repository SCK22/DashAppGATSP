...
if __name__ != "__main__":
			...
			try:
				...
				warnings.warn("""Could not load mpl_toolkits, the package is either not available for the os you are using or is not available in the scope of the class.This will not affect the functionality of the class, you cannot generate plots.""", stacklevel=1)
			try:
				from geopy.geocoders import Nominatim
			except ModuleNotFoundError:
				warnings.warn("""Could not load geopy, the package is either not available for the os you are using or is not available in the scope of the class.This will not affect the functionality of the class, you cannot generate plots""", stacklevel=1)
